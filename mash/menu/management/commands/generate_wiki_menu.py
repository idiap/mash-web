...
"""
A management command which generates a MediaWiki template containing the MASH top bar.
"""
...
class Command(BaseCommand):
    help = "Generates a MediaWiki template containing the MASH top bar"
    ...
    def handle(self, *args, **options):
        ...
        template = loader.get_template('menu/mediawiki_header.html')
        context = Context({
        ...
        template = loader.get_template('menu/mediawiki_stylesheets.html')
        context = Context({
            'urls_prefix': urls_prefix,
        })
        output = template.render(context)
