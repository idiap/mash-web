			...
			html: '',
		 	buttons: {
		  	...
		  	position: { 
		   	...
		   	submit: function onDone(){            /// MASH MODIF
		   }                                      /// MASH MODIF
                                              /// MASH MODIF
	  	}
	};
	...
	$.prompt.position = function(e){
		...
		if($.prompt.states[$.prompt.currentStateName].position.container){
			...
			if($.isPlainObject(offset) && offset.top !== undefined){
				...
				$('body').animate({ scrollTop: top }, 'slow', 'swing', function(){});                                       /// MASH MODIF
				$('html').animate({ scrollTop: top }, 'slow', 'swing', $.prompt.states[$.prompt.currentStateName].onDone);  /// MASH MODIF
			}
		}
